...
# Invocation: brainome cifar10_train_data.csv --yes -o brainome_out_e20.py -f NN -e 20
# Total compiler execution time: 0:23:56.93. Finished on: Apr-22-2022 19:26:37.
# This source code requires Python 3.
#
"""

[01;1mPredictor:[0m                        brainome_out_e20.py
    Classifier Type:              Neural Network
    System Type:                  Binary classifier
    Training / Validation Split:  60% : 40%
    Accuracy:
      Best-guess accuracy:        50.00%
      Training accuracy:          89.07% (53445/60000 correct)
      Validation Accuracy:        89.31% (35724/40000 correct)
      Combined Model Accuracy:    89.16% (89169/100000 correct)


    Model Capacity (MEC):         41    bits
    Generalization Ratio:       1303.53 bits/bit
    Percent of Data Memorized:     0.15%
    Resilience to Noise:          -3.12 dB
    ...
    Training Accuracy by Class:
               ...
               ----- | ------ ------ ------ ------ -------- -------- -------- -------- -------- --------
                   1 |  26554   3109  26891   3446   88.51%   89.64%   89.52%   88.64%   89.01%   80.20%
                   0 |  26891   3446  26554   3109   89.64%   88.51%   88.64%   89.52%   89.14%   80.40%

    Validation Accuracy by Class:
               Label |     TP     FP     TN     FN     TPR      TNR      PPV      NPV       F1       TS 
               ----- | ------ ------ ------ ------ -------- -------- -------- -------- -------- --------
                   1 |  17729   2005  17995   2271   88.64%   89.98%   89.84%   88.79%   89.24%   80.57%
                   0 |  17995   2271  17729   2005   89.98%   88.64%   88.79%   89.84%   89.38%   80.80%
...
TRAINFILE = ['cifar10_train_data.csv']
mapping = {'1': 0, '0': 1}
ignorelabels = []
ignorecolumns = []
target = ''
...
n_classes = 2
model_cap = 41
w_h = np.array([[-0.35479068756103516, 0.34220263361930847, 0.40516236424446106, 0.1715918779373169, -0.18260639905929565, 0.04764743149280548, 0.44242364168167114, -0.5482879877090454], [0.8231130838394165, -1.6037671566009521, 0.052392445504665375, -0.07437711954116821, 0.04511383920907974, 0.28983333706855774, 1.5678704977035522, -1.6595489978790283], [0.6083763241767883, -1.4515708684921265, -0.14903540909290314, -0.10021329671144485, -0.35134440660476685, 0.5206678509712219, 1.4435830116271973, -0.835932731628418], [1.1874018907546997, -1.9099080562591553, -0.29258987307548523, -0.1382935792207718, 0.037768132984638214, 0.5815708637237549, 1.5952099561691284, -1.3940258026123047]])
b_h = np.array([-36.048858642578125, 0.3516058921813965, -0.019638944417238235, -0.02820918709039688])
w_o = np.array([[0.1960691660642624, 9.261313438415527, 16.465417861938477, 35.39243698120117]])
b_o = np.array(-3.7011899948120117)
